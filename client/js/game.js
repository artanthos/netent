...
class Game {
    ...
    init() {
        ...
        config.dom.state.innerHTML = config.localizations.info.default;
        this.initSlots();
        this.initButton();
    ...
    newRound() {
        ...
        config.dom.state.innerHTML = config.localizations.info.spinning;
    ...
    fetchResults() {
        ...
        // let request = _.fetchFrom(`answer${ra}.json`);
        let request = _.fetchFrom(`api/getAnswer`);
    ...
    digest(answer) {
        ...
        if (answer.bonus) {
            setTimeout(() => {
                config.dom.prompt.innerHTML = config.localizations.prompts[answer.win];
